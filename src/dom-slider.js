(function () {
    ...
    function slide({
        ...
        if (isDisplayNoneByDefault) {
            styleSetter.display = displayWhenVisible;
        ...
        if (direction === 'up' &&
            (
                element.classList.contains('DOM-slider-hidden') || [...element.classList].some(e => new RegExp(/DOM-slider-setHeight/).test(e))
            ) &&
            !isDisplayNoneByDefault
        ) return Promise.resolve()
    ...
    (function domSliderInit() {
        ...
        function slideToggle({
            ...
            if (displayValue === 'none' || element.classList.contains('DOM-slider-hidden')) {
                return slide({
                    element,
                    slideSpeed,
                    direction: 'down',
